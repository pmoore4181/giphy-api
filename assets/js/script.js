...
function retrieveGifInfo() {
    ...
    $.ajax({
        ...
        for (var i = 0; i <= 9; i++) {
            ...
            $("#animalGifs")
                .append("<div style='margin-left:20px;' class='gifRating'>Rating: " + gifRating + "</div>")
                .append("<img style='margin-left:20px;' class='gif' data-state='still' src='" + stillGif + "' data-still='" + stillGif + "' data-animate='" + movingGif + "'>");
        }
